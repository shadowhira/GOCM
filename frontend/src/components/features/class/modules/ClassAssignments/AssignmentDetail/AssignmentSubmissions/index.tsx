...
// Sub-components
import { StatisticsCards, type SubmissionStats } from "./StatisticsCards";
...
export function AssignmentSubmissions({
  ...
  const submissionStats: SubmissionStats = useMemo(() => {
  ...
  return (
    <Card className="overflow-hidden">
      ...
      <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
        ...
        {/* Statistics Cards */}
        <StatisticsCards stats={submissionStats} t={t} />
